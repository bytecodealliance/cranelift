...
fn main() {
    ...
    /* Createing a function signature of fn(i32, i32) -> i32 */
    ...
    context.func.name = cranelift::codegen::ir::ExternalName::TestCase{ length: 3, ascii: [b's', b'u', b'm', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0', b'\0'] };
    ...
    let functionid = module.declare_function("sum", Linkage::Export, &context.func.signature).unwrap();
    ...
    /* Finalizes all functions in the module which finsihes all the patches and other realloctaions */
    module.finalize_definitions();

    /* Get the function pointer from the JIT */
    let function = module.get_finalized_function(functionid);
    /* Cast the raw function pointer a rust function pointer */
    let f: fn(i32, i32) -> i32 = unsafe { std::mem::transmute(function) };

    /* Print the result of the function */
    println!("14 + 48 = {}", f(14, 48));

    /* Turn the module into the backend's product type, in this case, nothing */
    let _ = module.finish();
}