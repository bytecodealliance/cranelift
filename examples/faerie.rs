...
fn main() {
    ...
    let builder = FaerieBuilder::new(isa, String::from("sum"), FaerieTrapCollection::Disabled, cranelift_module::default_libcall_names()).unwrap();
    ...
    /* Turn the module into the backend's product type, in this case, a binary artifact */
