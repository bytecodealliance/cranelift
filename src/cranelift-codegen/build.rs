// Build script.
//
// This program is run by Cargo when building src/cranelift-codegen. It is used to generate Rust code from
// the language definitions in the src/cranelift-codegen/meta directory.
//
// Environment:
//
// OUT_DIR
