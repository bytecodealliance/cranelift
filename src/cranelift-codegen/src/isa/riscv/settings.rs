...
// Include code generated by `src/cranelift-codegen/meta-python/gen_settings.py`. This file contains a public
// `Flags` struct with an impl for all of the settings defined in
// `src/cranelift-codegen/meta-python/isa/riscv/settings.py`.
