...
//!
//! The `src/cranelift-codegen/meta-python/constant_hash.py` Python module can generate constant hash tables
...
/// Must match `src/cranelift-codegen/meta-python/constant_hash.py` and `src/cranelift-codegen/meta/constant_hash.rs`.
