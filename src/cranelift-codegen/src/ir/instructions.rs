...
// Include code generated by `src/cranelift-codegen/meta-python/gen_instr.py`. This file contains:
//
...
// This trait really belongs in src/cranelift-reader where it is used by the `.clif` file parser, but since
