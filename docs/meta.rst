...
:file:`src/cranelift-codegen/meta-python` directory. The descriptions are processed in two
steps:
...
:file:`src/cranelift-codegen/meta-python/build.py` script which is invoked as part of the build
process if anything in the :file:`src/cranelift-codegen/meta-python` directory has changed
...
:file:`src/cranelift-codegen/meta-python/isa/*` directory.
...
:file:`src/cranelift-codegen/meta-python/isa`.
