...
impl Ieee32 {
    ...
    #[cfg(test)]
    pub fn new_from_float(x: f32) -> Ieee32 {
...
impl Ieee64 {
    ...
    #[cfg(test)]
    pub fn new_from_float(x: f64) -> Ieee64 {
...
mod tests {
    ...
    #[test]
    fn format_ieee32() {
        assert_eq!(Ieee32::new_from_float(0.0).to_string(), "0.0");
        assert_eq!(Ieee32::new_from_float(-0.0).to_string(), "-0.0");
        assert_eq!(Ieee32::new_from_float(1.0).to_string(), "0x1.000000p0");
        assert_eq!(Ieee32::new_from_float(1.5).to_string(), "0x1.800000p0");
        assert_eq!(Ieee32::new_from_float(0.5).to_string(), "0x1.000000p-1");
        assert_eq!(Ieee32::new_from_float(f32::EPSILON).to_string(),
                   "0x1.000000p-23");
        assert_eq!(Ieee32::new_from_float(f32::MIN).to_string(),
                   "-0x1.fffffep127");
        assert_eq!(Ieee32::new_from_float(f32::MAX).to_string(),
                   "0x1.fffffep127");
        // Smallest positive normal number.
        assert_eq!(Ieee32::new_from_float(f32::MIN_POSITIVE).to_string(),
                   "0x1.000000p-126");
        // Subnormals.
        assert_eq!(Ieee32::new_from_float(f32::MIN_POSITIVE / 2.0).to_string(),
                   "0x0.800000p-126");
        assert_eq!(Ieee32::new_from_float(f32::MIN_POSITIVE * f32::EPSILON).to_string(),
                   "0x0.000002p-126");
        assert_eq!(Ieee32::new_from_float(f32::INFINITY).to_string(), "+Inf");
        assert_eq!(Ieee32::new_from_float(f32::NEG_INFINITY).to_string(),
                   "-Inf");
        assert_eq!(Ieee32::new_from_float(f32::NAN).to_string(), "+NaN");
        assert_eq!(Ieee32::new_from_float(-f32::NAN).to_string(), "-NaN");
    ...
    #[test]
    fn format_ieee64() {
        assert_eq!(Ieee64::new_from_float(0.0).to_string(), "0.0");
        assert_eq!(Ieee64::new_from_float(-0.0).to_string(), "-0.0");
        assert_eq!(Ieee64::new_from_float(1.0).to_string(),
                   "0x1.0000000000000p0");
        assert_eq!(Ieee64::new_from_float(1.5).to_string(),
                   "0x1.8000000000000p0");
        assert_eq!(Ieee64::new_from_float(0.5).to_string(),
                   "0x1.0000000000000p-1");
        assert_eq!(Ieee64::new_from_float(f64::EPSILON).to_string(),
                   "0x1.0000000000000p-52");
        assert_eq!(Ieee64::new_from_float(f64::MIN).to_string(),
                   "-0x1.fffffffffffffp1023");
        assert_eq!(Ieee64::new_from_float(f64::MAX).to_string(),
                   "0x1.fffffffffffffp1023");
        // Smallest positive normal number.
        assert_eq!(Ieee64::new_from_float(f64::MIN_POSITIVE).to_string(),
                   "0x1.0000000000000p-1022");
        // Subnormals.
        assert_eq!(Ieee64::new_from_float(f64::MIN_POSITIVE / 2.0).to_string(),
                   "0x0.8000000000000p-1022");
        assert_eq!(Ieee64::new_from_float(f64::MIN_POSITIVE * f64::EPSILON).to_string(),
                   "0x0.0000000000001p-1022");
        assert_eq!(Ieee64::new_from_float(f64::INFINITY).to_string(), "+Inf");
        assert_eq!(Ieee64::new_from_float(f64::NEG_INFINITY).to_string(),
                   "-Inf");
        assert_eq!(Ieee64::new_from_float(f64::NAN).to_string(), "+NaN");
        assert_eq!(Ieee64::new_from_float(-f64::NAN).to_string(), "-NaN");
        // Construct some qNaNs with payloads.
