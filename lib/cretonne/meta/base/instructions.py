...
load = Instruction(
        ...
        """,
        ins=(Flags, p, Offset), outs=a, may_load=True)
...
store = Instruction(
        ...
        """,
        ins=(Flags, x, p, Offset), may_store=True)
...
stack_load = Instruction(
        ...
        """,
        ins=(SS, Offset), outs=a, may_load=True)
...
stack_store = Instruction(
        ...
        :math:`sizeof(a) + Offset <= sizeof(SS)`.
        """,
        ins=(x, SS, Offset), may_store=True)
...
heap_load = Instruction(
        ...
        """,
        ins=(p, Offset), outs=a, may_load=True)
