...
X86_64.enc(base.jump_table_entry.i32.any, *r.jt_entry.rex(0x8b))
X86_64.enc(base.jump_table_entry.i32.any, *r.jt_entry(0x8b))
X86_64.enc(base.jump_table_entry.i64.any, *r.jt_entry.rex(0x8b, w=1))
